...
ifneq ($(filter libjni_tinyplanet libjpeg librsjni libRSSupport, $(PRODUCT_GOOGLE_PREBUILT_MODULES)), )
    LOCAL_PREBUILT_LIBS += libjpeg.so \
                           librsjni.so \    
...
# GalleryGoogle
include $(CLEAR_VARS)
ifneq ($(filter libjni_eglfence libjni_filtershow_filters libjni_jpegstream, $(PRODUCT_GOOGLE_PREBUILT_MODULES)), )
...
# Chrome
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := libchrome.1916.141.so
LOCAL_MODULE_TAGS := optional
include $(BUILD_MULTI_PREBUILT)
...
# Drive
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := libdocscanner_image.so \
...
# Maps
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := libgmm-jni.so
LOCAL_MODULE_TAGS := optional
include $(BUILD_MULTI_PREBUILT)
...
# Hangouts
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := libframesequence.so \
                       libvideochat_jni.so
LOCAL_MODULE_TAGS := optional
include $(BUILD_MULTI_PREBUILT)
...
# YouTube
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := libm2ts_player.so
LOCAL_MODULE_TAGS := optional
include $(BUILD_MULTI_PREBUILT)
...
# GoogleTTS
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := libpatts_engine_jni_api_ub.210030103.so \
                       libspeexwrapper.so
LOCAL_MODULE_TAGS := optional
include $(BUILD_MULTI_PREBUILT)
